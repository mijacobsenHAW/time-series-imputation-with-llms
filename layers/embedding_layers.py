...
class PositionalEmbedding(nn.Module):
    def __init__(self, d_model, max_len=5000):
        """
        Initializes positional encodings using sinusoidal functions.
        See https://pytorch.org/tutorials/beginner/transformer_tutorial.html for
        positional encoding method
        Args:
            d_model (int): Size of each positional encoding vector.
    ...
    def forward(self, x):
        """
        Retrieves positional encodings for the input sequence.

        Args:
            x (Tensor): Input tensor for which to get positional encodings.

        Returns:
            Tensor: Positional encodings for the input sequence length.
        """
