...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_attention' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_ffn' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_add_layernorm' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_attention_add_layernorm' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_attention_ffn' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_ffn_add_layernorm' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
...
python -u run.py \
  ...
  --batch_size 16 \
  --model_dimension 768 \
  --description 'Experiment_ETTh2_0125_1703_attention_add_layernorm_ffn' \
  --iterations 1 \
  --mlp 1 \
  --learning_rate 0.001 \
  --lora True \
